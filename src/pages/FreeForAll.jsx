...
const FreeForAll = () => {
    ...
    const [playerThreeCoordinates, setPlayerThreeCoordinates] = useState([Math.floor(parseInt(localStorage.getItem('rows')) / 2), parseInt(localStorage.getItem('columns')) - 1])
                    ...
                    playerThreeRemainingStatPoints > 0 ?
                        ...
                        (playerOneStats.health > 0 && playerTwoStats.health > 0) || (playerOneStats.health > 0 && playerThreeStats.health > 0) || (playerTwoStats.health > 0 && playerThreeStats.health > 0) ?
                            ...
                            <section>
                                ...
                                <button onClick={() => { setPlayerOneCoordinates([parseInt(localStorage.getItem('rows')) - 1, 0]); setPlayerTwoCoordinates([0, 0]); setPlayerThreeCoordinates([Math.floor(parseInt(localStorage.getItem('rows')) / 2), parseInt(localStorage.getItem('columns')) - 1]); setPlayerOneActive(1); setRemainingMoves(parseInt(localStorage.getItem('actionPoints'))); setPlayerOneStats({ move: 1, range: 1, damage: 1, health: 1 }); setPlayerOneRemainingStatPoints(parseInt(localStorage.getItem('statPoints'))); setPlayerTwoStats({ move: 1, range: 1, damage: 1, health: 1 }); setPlayerTwoRemainingStatPoints(parseInt(localStorage.getItem('statPoints'))); setPlayerThreeStats({ move: 1, range: 1, damage: 1, health: 1 }); setPlayerThreeRemainingStatPoints(parseInt(localStorage.getItem('statPoints'))); setMessage(''); setHover('Hovering over: ') }}>Play Again</button>
                            </section>
            }
        </>
    )
